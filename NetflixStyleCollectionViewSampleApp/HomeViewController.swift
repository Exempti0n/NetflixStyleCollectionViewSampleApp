...
class HomeViewController: UICollectionViewController {
    ...
    //각각의 섹션 타입에 대한 UICollectionView 생성
    private func layout() -> UICollectionViewLayout{
        return UICollectionViewCompositionalLayout {[weak self]
            ...
            case .basic:
                return self.createBasicTypeSections()
            case .large:
    ...
    private func createBasicTypeSections() -> NSCollectionLayoutSection {
        //item
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case .rank:
            guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "ContentCollectionViewRankCell", for: indexPath) as?
                    ContentCollectionViewRankCell else { return
        ...
        case .main:
            guard let cell =
                    collectionView.dequeueReusableCell(withReuseIdentifier: "ContentCollectionViewMainCell", for: indexPath) as? ContentCollectionViewMainCell else { return
                UICollectionViewCell()
            }
